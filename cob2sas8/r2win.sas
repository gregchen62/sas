 /****************************************************************/
 /*                                                              */
 /* THIS PROGRAM IS A MODIFICATION OF R2MVS.  IT IS DESIGNED     */
 /* TO ALLOW COB2SAS TO RUN ON THE WINDOWS PLATFORMS.  PLEASE    */
 /* READ THE RDMEWIN.TXT FILE FOR MORE INFORMATION.              */
 /*                                                              */
 /****************************************************************/
 /*                                                              */
 /*    NAME: R2WIN                                               */
 ...
 /*                                                              */
 /*  AUTHOR: TOM ZACK                                            */
 /*  UPDATE: MARC HOWELL (MODIFIED TO RUN UNDER WINDOWS)         */
 /* SUPPORT: MARC HOWELL                                         */
 ...
 /****************************************************************/
  ...
  /*    LOG.                                                     */
  /*                                                             */
  %LET INFILE = INFILE INCOBOL END=EOF EOF=EODDSCTN truncover;
  %LET FILE = FILE LOG;
  %LET LIBREF = ;
  RUN;
  ...
  * %INCLUDE COB2SAS(R2COB4);
  ...
  /*-------------------------------------------------------------*/
  /* R2S370 IS TO BE USED IF YOU ARE USING COB2SAS ON YOUR PC    */
  /* READING DATA (ON YOUR PC) THAT WAS DOWNLOADED FROM A        */
  /* MAINFRAME SYSTEM *IN BINARY*.  IT TAKES THE INFORMATS       */
  /* GENERATED BY COB2SAS AND CONVERTS THEM TO THEIR S370        */
  /* EQUIVELENTS.  IF AN EBCDIC/ASCII CONVERSION HAPPENS WHEN    */
  /* YOU DOWNLOAD YOUR DATA FILE, THEN YOU DO NOT WANT TO USE    */
  /* R2S370; HOWEVER, ALL NUMERIC FIELDS WILL BE TRASHED.        */
  /* MARC HOWELL                                                 */
  /*-------------------------------------------------------------*/
    %INCLUDE COB2SAS(R2S370);
